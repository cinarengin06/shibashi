...
const g=StyleSheet.create({shenCue:{flexDirection:'row',alignItems:'center',gap:13},symbol:{fontSize:31},shenName:{fontSize:16,fontWeight:'800'},term:{color:colors.gold,fontSize:16,marginTop:2},label:{color:colors.cream,fontWeight:'700'},moods:{flexDirection:'row',justifyContent:'space-between'},mood:{width:48,height:48,borderRadius:24,backgroundColor:colors.surface2,alignItems:'center',justifyContent:'center'},input:{minHeight:110,textAlignVertical:'top',borderRadius:radii.md,backgroundColor:colors.deep,color:colors.cream,padding:14,fontSize:17,lineHeight:27},stats:{flexDirection:'row',gap:8},stat:{flex:1,alignItems:'center',gap:3},value:{color:colors.gold,fontSize:25,fontWeight:'800'},muted:{color:colors.muted,fontSize:16,lineHeight:24},date:{fontSize:16,fontWeight:'800'},note:{color:colors.cream,fontSize:17,lineHeight:27}});

...
import {regionCoachIds} from '../../data/coaches';
 ...
 return <Screen>
  ...
  {view==='bagua'?<>
   ...
   <Card style={[j.stageCard,{borderColor:`${shen.color}55`}]}>
    ...
    <Pressable onPress={()=>router.push(`/coaches?coach=${regionCoachIds[mapIndex]}`)} style={[j.coachButton,{borderColor:shen.color}]}><Ionicons name="chatbubble-ellipses-outline" color={shen.color} size={18}/><Text style={[j.smallButtonText,{color:shen.color}]}>Bu bölgenin rehberiyle konuş</Text></Pressable>

...
const s=StyleSheet.create({back:{height:40,alignSelf:'flex-start',flexDirection:'row',alignItems:'center',gap:7},backText:{color:colors.muted,fontSize:16,fontWeight:'700'},lead:{color:colors.muted,fontSize:16,lineHeight:26,marginTop:-12},coachGrid:{flexDirection:'row',flexWrap:'wrap',gap:7},coachChoice:{width:'23%',minHeight:66,borderRadius:16,borderWidth:1,borderColor:colors.line,backgroundColor:colors.surface,alignItems:'center',justifyContent:'center',gap:3},coachIcon:{fontSize:23},coachName:{color:colors.cream,fontSize:16,fontWeight:'700'},console:{gap:14},coachHead:{flexDirection:'row',alignItems:'center',gap:11},avatar:{width:56,height:56,borderRadius:28,borderWidth:1,alignItems:'center',justifyContent:'center',backgroundColor:colors.deep},avatarText:{fontSize:28},name:{color:colors.cream,fontSize:19,fontWeight:'800'},role:{color:colors.muted,fontSize:16,marginTop:2},tags:{flexDirection:'row',flexWrap:'wrap',gap:4,marginTop:5},tag:{fontSize:17,borderWidth:1,borderColor:colors.line,borderRadius:99,paddingHorizontal:6,paddingVertical:3},speak:{width:42,height:42,borderRadius:21,borderWidth:1,alignItems:'center',justifyContent:'center'},chat:{gap:8,minHeight:190,justifyContent:'flex-end'},bubble:{maxWidth:'88%',padding:11,borderRadius:15},guide:{alignSelf:'flex-start',backgroundColor:colors.surface2},user:{alignSelf:'flex-end',backgroundColor:'rgba(216,182,106,.18)'},bubbleText:{color:colors.cream,fontSize:16,lineHeight:24},intents:{flexDirection:'row',flexWrap:'wrap',gap:6},intent:{borderWidth:1,borderColor:colors.line,borderRadius:radii.pill,paddingHorizontal:10,paddingVertical:8},intentText:{color:colors.muted,fontSize:16,fontWeight:'700'},inputRow:{flexDirection:'row',gap:8},input:{flex:1,minHeight:48,borderRadius:radii.pill,backgroundColor:colors.deep,color:colors.cream,paddingHorizontal:15},send:{width:48,height:48,borderRadius:24,alignItems:'center',justifyContent:'center'}});

...
const s=StyleSheet.create({root:{flex:1,backgroundColor:'#0A0F0C'},safe:{flex:1},top:{height:70,paddingHorizontal:18,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},icon:{width:42,height:42,borderRadius:15,borderWidth:1,borderColor:'rgba(242,238,231,.14)',alignItems:'center',justifyContent:'center'},topCopy:{alignItems:'center'},kicker:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:9,letterSpacing:1.7},topTitle:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:19,marginTop:2},seal:{width:42,height:42,borderRadius:21,borderWidth:1,borderColor:'rgba(198,165,106,.38)',alignItems:'center',justifyContent:'center'},sealText:{color:colors.gold,fontSize:17},content:{padding:18,paddingBottom:54,gap:24},intro:{gap:10,paddingHorizontal:2},title:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:34,lineHeight:38,letterSpacing:-.5},lead:{fontFamily:fonts.sans,color:colors.muted,fontSize:13,lineHeight:21,maxWidth:340},featured:{height:410,borderRadius:26,overflow:'hidden',padding:18,justifyContent:'space-between',borderWidth:1,borderColor:'rgba(198,165,106,.34)'},image:{borderRadius:26},liveBadge:{alignSelf:'flex-start',flexDirection:'row',alignItems:'center',gap:6,paddingHorizontal:10,paddingVertical:7,borderRadius:99,backgroundColor:'rgba(10,15,12,.68)'},liveDot:{width:6,height:6,borderRadius:3,backgroundColor:'#A9D977'},liveText:{fontFamily:fonts.sansBold,color:'#DDEAD2',fontSize:8,letterSpacing:1.2},featureCopy:{gap:6},sceneQuality:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:9,letterSpacing:1.4},featureTitle:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:39},metaphor:{fontFamily:fonts.sans,color:'#D5D6D0',fontSize:13,lineHeight:20,maxWidth:310},begin:{alignSelf:'flex-start',height:43,marginTop:8,paddingHorizontal:16,borderRadius:22,backgroundColor:colors.gold,flexDirection:'row',alignItems:'center',gap:8},beginText:{fontFamily:fonts.sansBold,color:'#11150F',fontSize:12},sectionHead:{flexDirection:'row',alignItems:'flex-end',justifyContent:'space-between'},sectionTitle:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:25,lineHeight:29,marginTop:5,maxWidth:290},count:{fontFamily:fonts.metricStrong,color:colors.gold,fontSize:12},scenes:{gap:11,paddingRight:18},sceneCard:{width:240,height:290,padding:15,borderRadius:22,overflow:'hidden',justifyContent:'space-between',borderWidth:1,borderColor:'rgba(242,238,231,.12)'},cardTop:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},cardQuality:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:8,letterSpacing:1.3},cardState:{fontFamily:fonts.sansBold,color:colors.muted,fontSize:7,letterSpacing:1,paddingHorizontal:7,paddingVertical:5,borderRadius:99,backgroundColor:'rgba(10,15,12,.68)'},cardStateLive:{color:'#CFE9B5'},cardTitle:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:28},cardMetaphor:{fontFamily:fonts.sansMedium,color:'#DBDBD5',fontSize:11,lineHeight:17,marginTop:4},cardTempo:{fontFamily:fonts.sans,color:colors.muted,fontSize:9,marginTop:8},promise:{borderWidth:1,borderColor:'rgba(198,165,106,.17)',borderRadius:radii.lg,backgroundColor:'rgba(23,29,25,.72)',padding:17,gap:15},promiseLabel:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:8,letterSpacing:1.5},promiseRow:{gap:13},promiseItem:{flexDirection:'row',alignItems:'center',gap:11},promiseIcon:{width:34,height:34,borderRadius:17,borderWidth:1,borderColor:'rgba(198,165,106,.24)',alignItems:'center',justifyContent:'center'},promiseText:{fontFamily:fonts.sansMedium,color:'#D5D6D0',fontSize:12}});

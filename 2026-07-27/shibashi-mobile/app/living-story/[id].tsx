...
const s=StyleSheet.create({watchRoot:{flex:1,backgroundColor:'#0A0F0C'},watchImage:{resizeMode:'cover'},watchSafe:{flex:1,justifyContent:'space-between'},watchTop:{paddingHorizontal:18,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},round:{width:44,height:44,borderRadius:16,backgroundColor:'rgba(10,15,12,.68)',borderWidth:1,borderColor:'rgba(242,238,231,.16)',alignItems:'center',justifyContent:'center'},watchTopCopy:{alignItems:'center'},watchKicker:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:8,letterSpacing:1.4},watchName:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:18,marginTop:2},demoGhost:{position:'absolute',top:'11%',left:'20%',opacity:.8},watchBottom:{padding:20,gap:8},quality:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:9,letterSpacing:1.4},watchTitle:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:37,lineHeight:41},watchMetaphor:{fontFamily:fonts.sans,color:'#D0D2CC',fontSize:12,lineHeight:19,maxWidth:350},stepDots:{flexDirection:'row',gap:5,marginTop:8},stepDot:{flex:1,minHeight:42,alignItems:'center',gap:4},stepDotActive:{},stepNumber:{width:21,height:21,borderRadius:11,borderWidth:1,borderColor:'rgba(242,238,231,.18)',color:colors.muted,fontFamily:fonts.metric,fontSize:8,textAlign:'center',lineHeight:19},stepNumberActive:{backgroundColor:colors.gold,borderColor:colors.gold,color:'#11150F'},stepText:{fontFamily:fonts.sansMedium,color:colors.muted,fontSize:8},stepTextActive:{color:colors.cream},cue:{minHeight:62,padding:12,borderWidth:1,borderColor:'rgba(198,165,106,.22)',borderRadius:18,backgroundColor:'rgba(10,15,12,.7)',flexDirection:'row',alignItems:'center',gap:13},cueOrb:{width:33,height:33,borderRadius:17,borderWidth:1,borderColor:colors.gold,shadowColor:colors.gold,shadowOpacity:.25,shadowRadius:10},cueLabel:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:8,letterSpacing:1.2},cueText:{fontFamily:fonts.sansMedium,color:colors.cream,fontSize:12,marginTop:3},watchActions:{flexDirection:'row',gap:8,marginTop:4},primary:{flex:1,height:52,borderRadius:26,backgroundColor:colors.gold,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8},primaryWide:{height:54,borderRadius:27,backgroundColor:colors.gold,flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8,marginTop:5},primaryText:{fontFamily:fonts.sansBold,color:'#11150F',fontSize:13},secondary:{flex:1,height:52,borderRadius:26,borderWidth:1,borderColor:'rgba(242,238,231,.18)',backgroundColor:'rgba(10,15,12,.7)',flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8},secondaryWide:{height:52,borderRadius:26,borderWidth:1,borderColor:'rgba(242,238,231,.16)',alignItems:'center',justifyContent:'center'},secondaryText:{fontFamily:fonts.sansBold,color:colors.cream,fontSize:12},cameraRoot:{flex:1,backgroundColor:'#050806'},cameraShade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(3,8,5,.12)'},cameraSafe:{flex:1,justifyContent:'space-between'},cameraTop:{paddingHorizontal:16,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},cameraStep:{minWidth:125,height:45,borderRadius:23,backgroundColor:'rgba(10,15,12,.72)',borderWidth:1,borderColor:'rgba(242,238,231,.14)',flexDirection:'row',alignItems:'center',justifyContent:'center',gap:8},cameraStepCount:{fontFamily:fonts.metricStrong,color:'#A9D977',fontSize:11},cameraStepTitle:{fontFamily:fonts.sansMedium,color:colors.cream,fontSize:12},cameraCenter:{position:'absolute',top:102,left:0,right:0,alignItems:'center'},breath:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:20,backgroundColor:'rgba(10,15,12,.58)',paddingHorizontal:16,paddingVertical:9,borderRadius:18,overflow:'hidden'},ghostWindow:{position:'absolute',zIndex:4,right:9,top:'18%',width:142,height:258,borderRadius:58,backgroundColor:'rgba(10,15,12,.7)',borderWidth:1,borderColor:'rgba(243,207,139,.48)',alignItems:'center',overflow:'hidden',shadowColor:'#F3CF8B',shadowOpacity:.22,shadowRadius:14},ghostLabel:{fontFamily:fonts.sansBold,color:'#F3CF8B',fontSize:8,letterSpacing:1.2,marginTop:10},cameraBottom:{padding:16,gap:10},feedback:{alignSelf:'flex-start',maxWidth:'82%',padding:13,borderRadius:17,borderWidth:1,borderColor:'rgba(169,217,119,.25)',backgroundColor:'rgba(10,15,12,.78)',gap:4},feedbackState:{fontFamily:fonts.sansBold,color:'#A9D977',fontSize:8,letterSpacing:1.2},feedbackText:{fontFamily:fonts.sansMedium,color:colors.cream,fontSize:13,lineHeight:18},controls:{height:62,borderRadius:22,borderWidth:1,borderColor:'rgba(242,238,231,.13)',backgroundColor:'rgba(10,15,12,.82)',flexDirection:'row',alignItems:'center',paddingHorizontal:13,gap:12},progress:{height:3,flex:1,borderRadius:2,backgroundColor:'rgba(242,238,231,.13)',overflow:'hidden'},progressFill:{height:'100%',backgroundColor:colors.gold},pause:{width:40,height:40,borderRadius:20,backgroundColor:colors.gold,alignItems:'center',justifyContent:'center'},time:{fontFamily:fonts.metric,color:colors.cream,fontSize:10,minWidth:34},completeRoot:{flex:1,backgroundColor:'#0A0F0C'},completeSafe:{flex:1,padding:22,alignItems:'center',justifyContent:'center',gap:15},completeHalo:{width:126,height:126,borderRadius:63,borderWidth:5,borderColor:'#A9D977',borderRightColor:colors.gold,flexDirection:'row',alignItems:'center',justifyContent:'center'},completeScore:{fontFamily:fonts.metricStrong,color:colors.cream,fontSize:41},completeOf:{fontFamily:fonts.metric,color:colors.muted,fontSize:12,alignSelf:'flex-end',marginBottom:31},completeKicker:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:9,letterSpacing:1.5},completeTitle:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:35},completeLead:{fontFamily:fonts.sans,color:colors.muted,fontSize:12,lineHeight:19,textAlign:'center',maxWidth:330},metricGrid:{width:'100%',flexDirection:'row',flexWrap:'wrap',gap:8},metric:{width:'48%',minHeight:70,borderWidth:1,borderColor:'rgba(242,238,231,.09)',borderRadius:16,backgroundColor:'rgba(23,29,25,.76)',padding:12,gap:5},metricLabel:{fontFamily:fonts.sansBold,color:colors.muted,fontSize:7,letterSpacing:1},metricValue:{fontFamily:fonts.sansStrong,color:colors.cream,fontSize:13},master:{width:'100%',borderWidth:1,borderColor:'rgba(198,165,106,.2)',borderRadius:18,padding:16,alignItems:'center',gap:7},masterLabel:{fontFamily:fonts.sansBold,color:colors.gold,fontSize:8,letterSpacing:1.3},masterText:{fontFamily:fonts.displayMedium,color:colors.cream,fontSize:20,lineHeight:25,textAlign:'center'},improvement:{fontFamily:fonts.sans,color:colors.muted,fontSize:10,lineHeight:16,textAlign:'center'},homeLink:{fontFamily:fonts.sansMedium,color:colors.muted,fontSize:12,padding:9}});

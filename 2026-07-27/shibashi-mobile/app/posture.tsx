...
const p=StyleSheet.create({
 captureOverlay:{...StyleSheet.absoluteFillObject},captureImage:{width:'100%',height:'100%'},missingCapture:{flex:1,width:'100%',alignItems:'center',justifyContent:'center',padding:30,gap:10},missingCaptureText:{color:colors.muted,textAlign:'center',fontSize:12,lineHeight:18},pointLegend:{flexDirection:'row',gap:12,marginTop:4},legendItem:{color:colors.muted,fontSize:10,flexDirection:'row',alignItems:'center',gap:4},legendDot:{width:8,height:8,borderRadius:4},

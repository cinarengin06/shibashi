...
const c=StyleSheet.create({root:{flex:1,backgroundColor:colors.ink},shade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(5,10,7,.2)'},overlay:{flex:1,justifyContent:'space-between'},top:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:16},topCenter:{alignItems:'center'},movementTitle:{color:colors.cream,fontSize:14,fontWeight:'700'},progress:{color:colors.muted,fontSize:10,marginTop:2},icon:{width:44,height:44,borderRadius:15,backgroundColor:'rgba(17,23,19,.82)',borderWidth:1,borderColor:colors.line,alignItems:'center',justifyContent:'center'},setup:{position:'absolute',left:18,right:18,bottom:34,backgroundColor:'rgba(17,23,19,.96)',borderRadius:22,borderWidth:1,borderColor:colors.line,padding:18,gap:13},intentLabel:{color:colors.gold,fontSize:9,fontWeight:'900',letterSpacing:1.2},intent:{color:colors.cream,fontSize:22,lineHeight:30,fontFamily:'DMSerifDisplay_400Regular'},setupText:{color:colors.muted,fontSize:12,lineHeight:18},modeRow:{flexDirection:'row',gap:6},mode:{flex:1,minHeight:40,borderRadius:12,borderWidth:1,borderColor:colors.line,alignItems:'center',justifyContent:'center'},modeOn:{backgroundColor:colors.gold,borderColor:colors.gold},modeText:{color:colors.muted,fontSize:10,fontWeight:'700'},modeTextOn:{color:colors.ink},intentFloat:{position:'absolute',top:82,left:18,right:18,backgroundColor:'rgba(17,23,19,.86)',borderRadius:15,padding:12,borderWidth:1,borderColor:colors.line},intentSmall:{color:colors.cream,fontSize:14,lineHeight:20,marginTop:4},feedback:{position:'absolute',left:18,right:18,bottom:145,backgroundColor:'rgba(10,15,12,.88)',borderRadius:15,borderWidth:1,borderColor:colors.line,padding:12},feedbackLabel:{color:colors.gold,fontSize:9,fontWeight:'900',letterSpacing:1},feedbackText:{color:colors.cream,fontSize:13,lineHeight:19,marginTop:4},bottom:{backgroundColor:'rgba(10,15,12,.94)',padding:14,gap:10,borderTopWidth:1,borderColor:colors.line},controls:{flexDirection:'row',gap:6},control:{flex:1,minHeight:55,alignItems:'center',justifyContent:'center',gap:4},controlText:{color:colors.muted,fontSize:8,textAlign:'center'},finish:{height:48,borderRadius:radii.pill,borderWidth:1,borderColor:colors.gold,alignItems:'center',justifyContent:'center'},finishDisabled:{borderColor:colors.line,opacity:.7},finishText:{color:colors.cream,fontSize:13,fontWeight:'800'},finishTextDisabled:{color:colors.muted},permission:{flex:1,backgroundColor:colors.ink,padding:28,alignItems:'center',justifyContent:'center',gap:20},permissionIcon:{width:90,height:90,borderRadius:45,backgroundColor:colors.surface,alignItems:'center',justifyContent:'center'},permissionTitle:{color:colors.cream,fontSize:26,fontWeight:'700',textAlign:'center'},permissionBody:{color:colors.muted,fontSize:16,lineHeight:24,textAlign:'center'},cancel:{color:colors.muted,fontWeight:'600',padding:12}});

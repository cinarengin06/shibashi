...
const s=StyleSheet.create({back:{flexDirection:'row',alignItems:'center',gap:8},backText:{color:colors.cream,fontSize:16},lead:{color:colors.muted,fontSize:17,lineHeight:27},feelings:{flexDirection:'row',flexWrap:'wrap',gap:8},feeling:{borderWidth:1,borderColor:colors.line,borderRadius:radii.pill,paddingHorizontal:12,paddingVertical:9,backgroundColor:colors.surface},feelingText:{color:colors.muted,fontSize:17},input:{minHeight:150,color:colors.cream,fontSize:16,lineHeight:24,textAlignVertical:'top'},later:{color:colors.muted,textAlign:'center',padding:12,fontWeight:'600'}});
